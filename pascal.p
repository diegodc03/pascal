...
function comprobarNumeroRepetidoEnDatos(var juego: tipoJuego; jugadorIndex: integer; cartonIndex: integer; numero: string): boolean;
var 
...
begin    
    ...
    begin
        comprobarNumeroRepetidoEnDatos := true;
        exit;
    end;
    ...
    begin
        ...
        begin
            ...
            begin
                ...
                if comprobarNumeroRepetidoEnDatos(juego, jugadorIndex, cartonIndex, temp) then
                begin
